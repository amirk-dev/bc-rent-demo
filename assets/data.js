...
var DATA = (function () {
  ...
  var TENANTS = [
    ...
    /* Запас нужен, чтобы имён хватило на всех арендаторов. При коротком списке
       генератор шёл по кругу, и две компании появлялись дважды с разными БИН,
       что на экране читается как ошибка в данных. */
    'ТОО «Батыс Логистика»','Проектное бюро «Контур»','ТОО «Самал Фарм»',
    'ИП Жумабеков, реклама','ТОО «Алатау Пром»','Аудит «Есеп»'
  ];
